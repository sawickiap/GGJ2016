...
public class CharacterDemoController : MonoBehaviour 
{
	...
	public WeaponState 		characterWeaponState = WeaponState.UNARMED;
    ...
    /// <summary>
    ///  Sets character animation to walking.
    /// </summary>
    public void Move()
    {

        int oneHandedWeaponState = 1;

        if (Input.GetKey(KeyCode.Space))//ok, we can clear the right mouse button and use it for the next attack
        {

            animator.SetInteger("WeaponState", oneHandedWeaponState);
    ...
    public void Die( int deathMethod )
    {
        animator.SetInteger("Death", deathMethod);//the animator controller will detect death=3 and play DeathC
    }

    public void TriggerPainAnimation(int deathMethod)
    {
        animator.SetTrigger("Pain");//the animator controller will detect death=3 and play DeathC
    }

    public void SetNonCombat()
    {
        animator.SetBool("NonCombat", true);
    }
    ...
    {
        animator.SetInteger("WeaponState", (int)characterWeaponState);
    }
